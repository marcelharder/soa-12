...
export class ModeratorProcedureListResolver implements Resolve<Procedure[]> {
    pageNumber = 1;
    pageSize = 12;
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<Procedure[]> {
         return this.pservice.getModeratedProcedures(route.params.id, this.pageNumber, this.pageSize).pipe(catchError(error => {
